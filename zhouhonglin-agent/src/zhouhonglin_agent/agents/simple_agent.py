...
使用 LangGraph 实现一个基础的对话 Agent，支持工具调用
"""

from typing import TypedDict, Annotated, Sequence, List, Dict, Any, Callable, Optional
...
class SimpleAgent:
    ...
    def _agent_node(self, state: AgentState) -> AgentState:
        ...
        # 检查是否需要调用工具
        if self.enable_tools and "tool_calls" in ai_msg and ai_msg["tool_calls"]:
            return {
                "messages": [AIMessage(
