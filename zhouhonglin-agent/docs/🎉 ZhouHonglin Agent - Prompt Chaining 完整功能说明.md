# 🎉 zhouhonglin Agent - Prompt Chaining 完整功能说明
...
**文件**: `src/zhouhonglin_agent/agents/prompt_chaining_agent.py`
...
### 4. 深入掌握 (2小时+)
```
1. 研究源代码 src/zhouhonglin_agent/agents/prompt_chaining_agent.py
2. 理解每个预定义场景的设计思路
3. 学习最佳实践和设计模式
4. 创建复杂的自定义场景
5. 贡献新的预定义场景
...
- 💻 Web接口: `src/zhouhonglin_agent/web_app.py`
- 💻 前端界面: `src/zhouhonglin_agent/static/index.html`
