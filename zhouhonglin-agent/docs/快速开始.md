...
本指南将帮助你快速上手 zhouhonglin-agent 项目。
...
```bash
python -c "from src.zhouhonglin_agent import SimpleAgent; print('安装成功！')"
```
...
3. 提交 [GitHub Issue](https://github.com/your-username/zhouhonglin-agent/issues)
